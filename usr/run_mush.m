...
lmd      =  60;                  % shear viscosity liquid-weakening parameter

% stress control parameters
Pu       = -0.0;                 % ratio of pure-shear stress to buoyancy pressure
Si       =  0.20;                 % ratio of simple-shear stress to buoyancy pressure
B        =  0.1;                 % ratio of buoyancy force to 
...
beta     =  0.60;                % iterative damping parameter (fraction of previous step) [0,1]
gamma    =  0.75;                % iterative relaxation for rheology updates [0,1]
kappa    =  1.00;                % regularisation of effective viscosities [0,1]
