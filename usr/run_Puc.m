...
NN  = 200;
PU  = [1/4 ,1/8,1/4,1/4,1/2,1/2,1  ,1,2,2,4,4,8,8];
TY  = [1/4,1/8,1/8,1/4,1/4,1/2,1/2,1,1,2,2,4,4,8];

for i=1:length(TY)
    
    % set run parameters
    runID    = ['Puc',num2str(PU(i)),'_Ty',num2str(TY(i)),'_N',num2str(NN)]; runID(runID=='.') = '_'; % run identifier
