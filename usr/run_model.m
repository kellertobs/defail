...
N        =  240 + 2;             % number of grid points in z-direction (incl. 2 ghosts)
...
smx      =  L/10/h^2;            % smoothness of initial random noise in x-direction
smz      =  L/10/h^2;            % smoothness of initial random noise in z-direction
wx       =  L/40;                % horizontal half-width of gaussian
wz       =  L/40;                % vertical half-width of initial gaussian
